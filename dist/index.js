...
var Select = React__default['default'].forwardRef(function (_a, ref) {
    ...
    var _j = React__default['default'].useState(false), isOpen = _j[0], setOpen = _j[1];
    var _k = React__default['default'].useState(''), search = _k[0], setSearch = _k[1];
    var listRef = React__default['default'].useRef(null);
    var containerRef = React__default['default'].useRef(parentRef === null || parentRef === void 0 ? void 0 : parentRef.current);
    var _l = React__default['default'].useState(0), focused = _l[0], setFocused = _l[1];
    var inputProps = {
...
var Table = function (_a) {
    ...
    var finalChildren = React__default['default'].Children.map(children, function (child, index) {
        var _a;
        if (!React__default['default'].isValidElement(child)) {
            return child;
        }
...
var Tooltip = function (_a) {
    ...
    var _d = React__default['default'].useState(false), isOpen = _d[0], setIsOpen = _d[1];
